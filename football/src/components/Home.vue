...
<template>
  <div>
    ...
    <div class="section">
      <match-list :matchs="latstUpdated" heading="精彩赛事" @select="preview($event)">
      </match-list>
    </div>
    <div class="section">
      <match-list :matchs="recommended" heading="球星专区" @select="preview($event)">
      </match-list>
    </div>
    <modal-dd ref="dia">
        ...
        <div v-if="selected">
          ...
          <div v-if="selected.content">
            <div v-for="groups in selected.content">
              <div v-for="(group,key) in groups" class="dialog-group">
